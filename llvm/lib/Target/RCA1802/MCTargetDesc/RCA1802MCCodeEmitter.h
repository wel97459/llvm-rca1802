//===-- RCA1802MCCodeEmitter.h - Convert RCA1802 Code to Machine Code -------------===//
//
...
//===----------------------------------------------------------------------===//
//
// This file defines the RCA1802MCCodeEmitter class.
//
//===----------------------------------------------------------------------===//
//

#ifndef LLVM_RCA1802_CODE_EMITTER_H
#define LLVM_RCA1802_CODE_EMITTER_H
...
/// Writes RCA1802 machine code to a stream.
class RCA1802MCCodeEmitter : public MCCodeEmitter {
public:
  RCA1802MCCodeEmitter(const MCInstrInfo &MCII, MCContext &Ctx)
      : MCII(MCII), Ctx(Ctx) {}
...
private:
  ...
  RCA1802MCCodeEmitter(const RCA1802MCCodeEmitter &) = delete;
  void operator=(const RCA1802MCCodeEmitter &) = delete;
...
#endif // LLVM_RCA1802_CODE_EMITTER_H
