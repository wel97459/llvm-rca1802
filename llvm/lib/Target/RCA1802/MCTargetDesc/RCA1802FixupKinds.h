//===-- RCA1802FixupKinds.h - RCA1802 Specific Fixup Entries ------------*- C++ -*-===//
//
...
#ifndef LLVM_RCA1802_FIXUP_KINDS_H
#define LLVM_RCA1802_FIXUP_KINDS_H
...
///
/// Although rca1802t of the current fixup types reflect a unique relocation
/// one can have multiple fixup types for a given relocation and thus need
/// to be uniquely named.
///
/// \note This table *must* be in the same order of
///       MCFixupKindInfo Infos[RCA1802::NumTargetFixupKinds]
///       in `RCA1802FixupKinds.cpp`.
enum Fixups {
...
class RCA1802FixupKinds {
public:
  static MCFixupKindInfo getFixupKindInfo(const RCA1802::Fixups Kind,
                                          const MCAsmBackend *Alternative);
};
} // namespace llvm

#endif // LLVM_RCA1802_FIXUP_KINDS_H
